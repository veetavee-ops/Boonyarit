// ⚠️ FROZEN BACKUP — สำเนาแช่แข็งของ SummarySidebar เวอร์ชันก่อนรีดีไซน์ (ดู session log)
// เก็บไว้เผื่อ rollback เร็วถ้าดีไซน์ใหม่มีปัญหา — สลับกลับได้ด้วยการแก้ import ใน App.jsx บรรทัดเดียว:
//   import SummarySidebar from "./components/SummarySidebar/SummarySidebar";
//   →  import SummarySidebar from "./components/SummarySidebarLegacy/SummarySidebarLegacy";
// ไม่รองรับ custom AI provider (ฟีเจอร์ใหม่ที่เพิ่มพร้อมรีดีไซน์) — มีแค่ Groq/Gemini เหมือนเดิม
...
import "./SummarySidebarLegacy.css";
...
export default function SummarySidebarLegacy({
  isOpen,
  onClose,
  refreshKey,
  selectedDate,
